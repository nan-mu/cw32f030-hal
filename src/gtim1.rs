...
pub mod cnt;
#[doc = "CMMR (rw) register accessor: Capture compare control Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cmmr::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cmmr::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@cmmr`]
module"]
pub type CMMR = crate::Reg<cmmr::CMMR_SPEC>;
