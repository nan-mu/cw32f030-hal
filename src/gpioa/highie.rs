...
pub type R = crate::R<HIGHIE_SPEC>;
#[doc = "Register `HIGHIE` writer"]
pub type W = crate::W<HIGHIE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pin0(&mut self) -> PIN0_W<HIGHIE_SPEC, 0> {
        PIN0_W::new(self)
    }
    #[doc = "Bit 1 - desc PIN1"]
    #[inline(always)]
    #[must_use]
    pub fn pin1(&mut self) -> PIN1_W<HIGHIE_SPEC, 1> {
        PIN1_W::new(self)
    }
    #[doc = "Bit 2 - desc PIN2"]
    #[inline(always)]
    #[must_use]
    pub fn pin2(&mut self) -> PIN2_W<HIGHIE_SPEC, 2> {
        PIN2_W::new(self)
    }
    #[doc = "Bit 3 - desc PIN3"]
    #[inline(always)]
    #[must_use]
    pub fn pin3(&mut self) -> PIN3_W<HIGHIE_SPEC, 3> {
        PIN3_W::new(self)
    }
    #[doc = "Bit 4 - desc PIN4"]
    #[inline(always)]
    #[must_use]
    pub fn pin4(&mut self) -> PIN4_W<HIGHIE_SPEC, 4> {
        PIN4_W::new(self)
    }
    #[doc = "Bit 5 - desc PIN5"]
    #[inline(always)]
    #[must_use]
    pub fn pin5(&mut self) -> PIN5_W<HIGHIE_SPEC, 5> {
        PIN5_W::new(self)
    }
    #[doc = "Bit 6 - desc PIN6"]
    #[inline(always)]
    #[must_use]
    pub fn pin6(&mut self) -> PIN6_W<HIGHIE_SPEC, 6> {
        PIN6_W::new(self)
    }
    #[doc = "Bit 7 - desc PIN7"]
    #[inline(always)]
    #[must_use]
    pub fn pin7(&mut self) -> PIN7_W<HIGHIE_SPEC, 7> {
        PIN7_W::new(self)
    }
    #[doc = "Bit 8 - desc PIN8"]
    #[inline(always)]
    #[must_use]
    pub fn pin8(&mut self) -> PIN8_W<HIGHIE_SPEC, 8> {
        PIN8_W::new(self)
    }
    #[doc = "Bit 9 - desc PIN9"]
    #[inline(always)]
    #[must_use]
    pub fn pin9(&mut self) -> PIN9_W<HIGHIE_SPEC, 9> {
        PIN9_W::new(self)
    }
    #[doc = "Bit 10 - desc PIN10"]
    #[inline(always)]
    #[must_use]
    pub fn pin10(&mut self) -> PIN10_W<HIGHIE_SPEC, 10> {
        PIN10_W::new(self)
    }
    #[doc = "Bit 11 - desc PIN11"]
    #[inline(always)]
    #[must_use]
    pub fn pin11(&mut self) -> PIN11_W<HIGHIE_SPEC, 11> {
        PIN11_W::new(self)
    }
    #[doc = "Bit 12 - desc PIN12"]
    #[inline(always)]
    #[must_use]
    pub fn pin12(&mut self) -> PIN12_W<HIGHIE_SPEC, 12> {
        PIN12_W::new(self)
    }
    #[doc = "Bit 13 - desc PIN13"]
    #[inline(always)]
    #[must_use]
    pub fn pin13(&mut self) -> PIN13_W<HIGHIE_SPEC, 13> {
        PIN13_W::new(self)
    }
    #[doc = "Bit 14 - desc PIN14"]
    #[inline(always)]
    #[must_use]
    pub fn pin14(&mut self) -> PIN14_W<HIGHIE_SPEC, 14> {
        PIN14_W::new(self)
    }
    #[doc = "Bit 15 - desc PIN15"]
    #[inline(always)]
    #[must_use]
    pub fn pin15(&mut self) -> PIN15_W<HIGHIE_SPEC, 15> {
        PIN15_W::new(self)
    }
...
#[doc = "Interrupt enable register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`highie::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`highie::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HIGHIE_SPEC;
impl crate::RegisterSpec for HIGHIE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`highie::R`](R) reader structure"]
impl crate::Readable for HIGHIE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`highie::W`](W) writer structure"]
impl crate::Writable for HIGHIE_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HIGHIE to value 0"]
impl crate::Resettable for HIGHIE_SPEC {
