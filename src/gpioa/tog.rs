...
pub type R = crate::R<TOG_SPEC>;
#[doc = "Register `TOG` writer"]
pub type W = crate::W<TOG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pin2(&mut self) -> PIN2_W<TOG_SPEC, 2> {
        PIN2_W::new(self)
    }
    #[doc = "Bit 3 - desc PIN3"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pin4(&mut self) -> PIN4_W<TOG_SPEC, 4> {
        PIN4_W::new(self)
    }
    #[doc = "Bit 5 - desc PIN5"]
    #[inline(always)]
    #[must_use]
    pub fn pin5(&mut self) -> PIN5_W<TOG_SPEC, 5> {
        PIN5_W::new(self)
    }
    #[doc = "Bit 6 - desc PIN6"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pin8(&mut self) -> PIN8_W<TOG_SPEC, 8> {
        PIN8_W::new(self)
    }
    #[doc = "Bit 9 - desc PIN9"]
    #[inline(always)]
    #[must_use]
    pub fn pin9(&mut self) -> PIN9_W<TOG_SPEC, 9> {
        PIN9_W::new(self)
    }
    #[doc = "Bit 10 - desc PIN10"]
    #[inline(always)]
    #[must_use]
    pub fn pin10(&mut self) -> PIN10_W<TOG_SPEC, 10> {
        PIN10_W::new(self)
    }
    #[doc = "Bit 11 - desc PIN11"]
    #[inline(always)]
    #[must_use]
    pub fn pin11(&mut self) -> PIN11_W<TOG_SPEC, 11> {
        PIN11_W::new(self)
    }
    #[doc = "Bit 12 - desc PIN12"]
    #[inline(always)]
    #[must_use]
    pub fn pin12(&mut self) -> PIN12_W<TOG_SPEC, 12> {
        PIN12_W::new(self)
    }
    #[doc = "Bit 13 - desc PIN13"]
    #[inline(always)]
...
#[doc = "desc TOG\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tog::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tog::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TOG_SPEC;
impl crate::RegisterSpec for TOG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tog::R`](R) reader structure"]
impl crate::Readable for TOG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`tog::W`](W) writer structure"]
impl crate::Writable for TOG_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TOG to value 0"]
impl crate::Resettable for TOG_SPEC {
