...
pub type R = crate::R<RESETFLAG_SPEC>;
#[doc = "Register `RESETFLAG` writer"]
pub type W = crate::W<RESETFLAG_SPEC>;
...
pub type LVD_R = crate::BitReader;
#[doc = "Field `LVD` writer - desc LVD"]
pub type LVD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RSTB_R = crate::BitReader;
#[doc = "Field `RSTB` writer - desc RSTB"]
pub type RSTB_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
