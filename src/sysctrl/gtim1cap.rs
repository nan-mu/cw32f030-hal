#[doc = "Register `GTIM1CAP` reader"]
pub type R = crate::R<GTIM1CAP_SPEC>;
#[doc = "Register `GTIM1CAP` writer"]
pub type W = crate::W<GTIM1CAP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch1(&mut self) -> CH1_W<GTIM1CAP_SPEC, 0> {
        CH1_W::new(self)
    }
    #[doc = "Bits 4:6 - desc CH2"]
    #[inline(always)]
    #[must_use]
    pub fn ch2(&mut self) -> CH2_W<GTIM1CAP_SPEC, 4> {
        CH2_W::new(self)
    }
    #[doc = "Bits 8:10 - desc CH3"]
    #[inline(always)]
    #[must_use]
    pub fn ch3(&mut self) -> CH3_W<GTIM1CAP_SPEC, 8> {
        CH3_W::new(self)
    }
    #[doc = "Bits 12:14 - desc CH4"]
    #[inline(always)]
    #[must_use]
    pub fn ch4(&mut self) -> CH4_W<GTIM1CAP_SPEC, 12> {
        CH4_W::new(self)
    }
...
#[doc = "GTIM1 CAP Control Reg\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gtim1cap::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gtim1cap::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GTIM1CAP_SPEC;
impl crate::RegisterSpec for GTIM1CAP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gtim1cap::R`](R) reader structure"]
impl crate::Readable for GTIM1CAP_SPEC {}
#[doc = "`write(|w| ..)` method takes [`gtim1cap::W`](W) writer structure"]
impl crate::Writable for GTIM1CAP_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GTIM1CAP to value 0"]
impl crate::Resettable for GTIM1CAP_SPEC {
