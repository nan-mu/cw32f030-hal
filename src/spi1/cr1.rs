...
pub type LSBF_R = crate::BitReader;
#[doc = "Field `LSBF` writer - desc LSBF"]
pub type LSBF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `SMP` reader - desc SMP"]
pub type SMP_R = crate::BitReader;
#[doc = "Field `SMP` writer - desc SMP"]
pub type SMP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type WIDTH_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type MISOHD_R = crate::BitReader;
#[doc = "Field `MISOHD` writer - desc MISOHD"]
pub type MISOHD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 0 - desc CPHA"]
    #[inline(always)]
