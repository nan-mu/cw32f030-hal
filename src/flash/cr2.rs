...
pub type WAIT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `FETCH` reader - desc FETCH"]
pub type FETCH_R = crate::BitReader;
#[doc = "Field `FETCH` writer - desc FETCH"]
pub type FETCH_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CACHE` reader - desc CACHE"]
pub type CACHE_R = crate::BitReader;
#[doc = "Field `CACHE` writer - desc CACHE"]
pub type CACHE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
