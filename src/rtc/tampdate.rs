...
pub type R = crate::R<TAMPDATE_SPEC>;
#[doc = "Register `TAMPDATE` writer"]
pub type W = crate::W<TAMPDATE_SPEC>;
#[doc = "Field `DAY` reader - desc DAY"]
pub type DAY_R = crate::FieldReader;
#[doc = "Field `DAY` writer - desc DAY"]
pub type DAY_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
...
pub type WEEK_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
impl R {
...
#[doc = "desc TAMPDATE\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tampdate::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tampdate::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TAMPDATE_SPEC;
impl crate::RegisterSpec for TAMPDATE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tampdate::R`](R) reader structure"]
impl crate::Readable for TAMPDATE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`tampdate::W`](W) writer structure"]
impl crate::Writable for TAMPDATE_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TAMPDATE to value 0"]
impl crate::Resettable for TAMPDATE_SPEC {
