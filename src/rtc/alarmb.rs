...
pub type R = crate::R<ALARMB_SPEC>;
#[doc = "Register `ALARMB` writer"]
pub type W = crate::W<ALARMB_SPEC>;
...
#[doc = "Alarm - B\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`alarmb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`alarmb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ALARMB_SPEC;
impl crate::RegisterSpec for ALARMB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`alarmb::R`](R) reader structure"]
impl crate::Readable for ALARMB_SPEC {}
#[doc = "`write(|w| ..)` method takes [`alarmb::W`](W) writer structure"]
impl crate::Writable for ALARMB_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ALARMB to value 0"]
impl crate::Resettable for ALARMB_SPEC {
