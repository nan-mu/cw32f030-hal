...
pub type PARITY_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type OVER_R = crate::FieldReader;
#[doc = "Field `OVER` writer - desc OVER"]
pub type OVER_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
    #[doc = "Bit 0 - desc TXEN"]
    #[inline(always)]
