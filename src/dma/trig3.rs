...
pub type R = crate::R<TRIG3_SPEC>;
#[doc = "Register `TRIG3` writer"]
pub type W = crate::W<TRIG3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn type_(&mut self) -> TYPE_W<TRIG3_SPEC, 0> {
        TYPE_W::new(self)
    }
    #[doc = "Bit 1 - desc SOFTSRC"]
    #[inline(always)]
    #[must_use]
    pub fn softsrc(&mut self) -> SOFTSRC_W<TRIG3_SPEC, 1> {
        SOFTSRC_W::new(self)
    }
    #[doc = "Bits 2:7 - desc HARDSRC"]
    #[inline(always)]
    #[must_use]
    pub fn hardsrc(&mut self) -> HARDSRC_W<TRIG3_SPEC, 2> {
        HARDSRC_W::new(self)
    }
...
#[doc = "Channel3 trigger register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`trig3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`trig3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TRIG3_SPEC;
impl crate::RegisterSpec for TRIG3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`trig3::R`](R) reader structure"]
impl crate::Readable for TRIG3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`trig3::W`](W) writer structure"]
impl crate::Writable for TRIG3_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TRIG3 to value 0"]
impl crate::Resettable for TRIG3_SPEC {
