...
pub type R = crate::R<CNT3_SPEC>;
#[doc = "Register `CNT3` writer"]
pub type W = crate::W<CNT3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CNT_W<CNT3_SPEC, 0> {
        CNT_W::new(self)
    }
    #[doc = "Bits 16:19 - desc REPEAT"]
    #[inline(always)]
    #[must_use]
    pub fn repeat(&mut self) -> REPEAT_W<CNT3_SPEC, 16> {
        REPEAT_W::new(self)
    }
...
#[doc = "Channel3 counter register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cnt3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cnt3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CNT3_SPEC;
impl crate::RegisterSpec for CNT3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cnt3::R`](R) reader structure"]
impl crate::Readable for CNT3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`cnt3::W`](W) writer structure"]
impl crate::Writable for CNT3_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CNT3 to value 0"]
impl crate::Resettable for CNT3_SPEC {
