...
pub type R = crate::R<SRCADDR2_SPEC>;
#[doc = "Register `SRCADDR2` writer"]
pub type W = crate::W<SRCADDR2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srcaddr(&mut self) -> SRCADDR_W<SRCADDR2_SPEC, 0> {
        SRCADDR_W::new(self)
    }
...
#[doc = "Channel2 source address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`srcaddr2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`srcaddr2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SRCADDR2_SPEC;
impl crate::RegisterSpec for SRCADDR2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`srcaddr2::R`](R) reader structure"]
impl crate::Readable for SRCADDR2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`srcaddr2::W`](W) writer structure"]
impl crate::Writable for SRCADDR2_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SRCADDR2 to value 0"]
impl crate::Resettable for SRCADDR2_SPEC {
