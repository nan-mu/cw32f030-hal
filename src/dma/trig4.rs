...
pub type R = crate::R<TRIG4_SPEC>;
#[doc = "Register `TRIG4` writer"]
pub type W = crate::W<TRIG4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn type_(&mut self) -> TYPE_W<TRIG4_SPEC, 0> {
        TYPE_W::new(self)
    }
    #[doc = "Bit 1 - desc SOFTSRC"]
    #[inline(always)]
    #[must_use]
    pub fn softsrc(&mut self) -> SOFTSRC_W<TRIG4_SPEC, 1> {
        SOFTSRC_W::new(self)
    }
    #[doc = "Bits 2:7 - desc HARDSRC"]
    #[inline(always)]
    #[must_use]
    pub fn hardsrc(&mut self) -> HARDSRC_W<TRIG4_SPEC, 2> {
        HARDSRC_W::new(self)
    }
...
#[doc = "Channel4 trigger register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`trig4::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`trig4::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TRIG4_SPEC;
impl crate::RegisterSpec for TRIG4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`trig4::R`](R) reader structure"]
impl crate::Readable for TRIG4_SPEC {}
#[doc = "`write(|w| ..)` method takes [`trig4::W`](W) writer structure"]
impl crate::Writable for TRIG4_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TRIG4 to value 0"]
impl crate::Resettable for TRIG4_SPEC {
