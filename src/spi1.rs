...
pub mod cr2;
#[doc = "SSI (rw) register accessor: Slave slect register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ssi::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ssi::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@ssi`]
module"]
pub type SSI = crate::Reg<ssi::SSI_SPEC>;
