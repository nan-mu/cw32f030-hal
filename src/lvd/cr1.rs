...
pub type RISE_R = crate::BitReader;
#[doc = "Field `RISE` writer - desc RISE"]
pub type RISE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `FALL` reader - desc FALL"]
pub type FALL_R = crate::BitReader;
#[doc = "Field `FALL` writer - desc FALL"]
pub type FALL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
