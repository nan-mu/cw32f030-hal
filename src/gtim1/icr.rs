...
pub type CC4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `DIRCHANGE` reader - desc DIRCHANGE"]
pub type DIRCHANGE_R = crate::BitReader;
#[doc = "Field `DIRCHANGE` writer - desc DIRCHANGE"]
pub type DIRCHANGE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 0 - desc OV"]
    #[inline(always)]
    pub fn ov(&self) -> OV_R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ud(&mut self) -> UD_W<ICR_SPEC, 2> {
        UD_W::new(self)
    }
    #[doc = "Bit 3 - desc CC1"]
    #[inline(always)]
    #[must_use]
    pub fn cc1(&mut self) -> CC1_W<ICR_SPEC, 3> {
        CC1_W::new(self)
    }
    #[doc = "Bit 4 - desc CC2"]
    #[inline(always)]
    #[must_use]
    pub fn cc2(&mut self) -> CC2_W<ICR_SPEC, 4> {
        CC2_W::new(self)
    }
    #[doc = "Bit 5 - desc CC3"]
    #[inline(always)]
    #[must_use]
    pub fn cc3(&mut self) -> CC3_W<ICR_SPEC, 5> {
        CC3_W::new(self)
    }
    #[doc = "Bit 6 - desc CC4"]
    #[inline(always)]
    #[must_use]
    pub fn cc4(&mut self) -> CC4_W<ICR_SPEC, 6> {
        CC4_W::new(self)
    }
    #[doc = "Bit 9 - desc DIRCHANGE"]
    #[inline(always)]
    #[must_use]
    pub fn dirchange(&mut self) -> DIRCHANGE_W<ICR_SPEC, 9> {
