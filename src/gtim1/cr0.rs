...
pub type ENCMODE_R = crate::FieldReader;
#[doc = "Field `ENCMODE` writer - desc ENCMODE"]
pub type ENCMODE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
#[doc = "Field `ENCRESET` reader - desc ENCRESET"]
pub type ENCRESET_R = crate::FieldReader;
#[doc = "Field `ENCRESET` writer - desc ENCRESET"]
pub type ENCRESET_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
#[doc = "Field `ENCRELOAD` reader - desc ENCRELOAD"]
pub type ENCRELOAD_R = crate::FieldReader;
#[doc = "Field `ENCRELOAD` writer - desc ENCRELOAD"]
pub type ENCRELOAD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
    #[doc = "Bit 0 - desc EN"]
    #[inline(always)]
    pub fn en(&self) -> EN_R {
