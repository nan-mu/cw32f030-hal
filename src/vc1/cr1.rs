...
pub type FLTTIME_R = crate::FieldReader;
#[doc = "Field `FLTTIME` writer - desc FLTTIME"]
pub type FLTTIME_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `FLTCLK` reader - desc FLTCLK"]
pub type FLTCLK_R = crate::BitReader;
#[doc = "Field `FLTCLK` writer - desc FLTCLK"]
pub type FLTCLK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `FALLIE` reader - desc FALLIE"]
pub type FALLIE_R = crate::BitReader;
#[doc = "Field `FALLIE` writer - desc FALLIE"]
pub type FALLIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `RISEIE` reader - desc RISEIE"]
pub type RISEIE_R = crate::BitReader;
#[doc = "Field `RISEIE` writer - desc RISEIE"]
pub type RISEIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `HIGHIE` reader - desc HIGHIE"]
pub type HIGHIE_R = crate::BitReader;
#[doc = "Field `HIGHIE` writer - desc HIGHIE"]
pub type HIGHIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ATIMCLR` reader - desc ATIMCLR"]
pub type ATIMCLR_R = crate::BitReader;
#[doc = "Field `ATIMCLR` writer - desc ATIMCLR"]
pub type ATIMCLR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ATIMBK` reader - desc ATIMBK"]
pub type ATIMBK_R = crate::BitReader;
#[doc = "Field `ATIMBK` writer - desc ATIMBK"]
pub type ATIMBK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `BLANKCH1B` reader - desc BLANKCH1B"]
pub type BLANKCH1B_R = crate::BitReader;
#[doc = "Field `BLANKCH1B` writer - desc BLANKCH1B"]
pub type BLANKCH1B_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `BLANKCH2B` reader - desc BLANKCH2B"]
pub type BLANKCH2B_R = crate::BitReader;
#[doc = "Field `BLANKCH2B` writer - desc BLANKCH2B"]
pub type BLANKCH2B_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `BLANKCH3B` reader - desc BLANKCH3B"]
pub type BLANKCH3B_R = crate::BitReader;
#[doc = "Field `BLANKCH3B` writer - desc BLANKCH3B"]
pub type BLANKCH3B_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `BLANKFLT` reader - desc BLANKFLT"]
pub type BLANKFLT_R = crate::FieldReader;
#[doc = "Field `BLANKFLT` writer - desc BLANKFLT"]
pub type BLANKFLT_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
impl R {
