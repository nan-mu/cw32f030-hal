...
pub type UNDF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `C4AF` reader - desc C4AF"]
pub type C4AF_R = crate::BitReader;
#[doc = "Field `C4AF` writer - desc C4AF"]
pub type C4AF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 0 - desc UIF"]
    #[inline(always)]
