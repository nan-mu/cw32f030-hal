...
pub type UEVE_R = crate::BitReader;
#[doc = "Field `UEVE` writer - desc UEVE"]
pub type UEVE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CM1AE` reader - desc CM1AE"]
pub type CM1AE_R = crate::BitReader;
#[doc = "Field `CM1AE` writer - desc CM1AE"]
pub type CM1AE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CM2AE` reader - desc CM2AE"]
pub type CM2AE_R = crate::BitReader;
#[doc = "Field `CM2AE` writer - desc CM2AE"]
pub type CM2AE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CM3AE` reader - desc CM3AE"]
pub type CM3AE_R = crate::BitReader;
#[doc = "Field `CM3AE` writer - desc CM3AE"]
pub type CM3AE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CM1BE` reader - desc CM1BE"]
pub type CM1BE_R = crate::BitReader;
#[doc = "Field `CM1BE` writer - desc CM1BE"]
pub type CM1BE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CM2BE` reader - desc CM2BE"]
pub type CM2BE_R = crate::BitReader;
#[doc = "Field `CM2BE` writer - desc CM2BE"]
pub type CM2BE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `CM3BE` reader - desc CM3BE"]
pub type CM3BE_R = crate::BitReader;
#[doc = "Field `CM3BE` writer - desc CM3BE"]
pub type CM3BE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ADTE` reader - desc ADTE"]
pub type ADTE_R = crate::BitReader;
#[doc = "Field `ADTE` writer - desc ADTE"]
pub type ADTE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    #[doc = "Bit 0 - desc UEVE"]
    #[inline(always)]
