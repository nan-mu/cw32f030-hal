...
pub type DTR_R = crate::FieldReader;
#[doc = "Field `DTR` writer - desc DTR"]
pub type DTR_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type SAFEEN_R = crate::BitReader;
#[doc = "Field `SAFEEN` writer - desc SAFEEN"]
pub type SAFEEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `VCE` reader - desc VCE"]
pub type VCE_R = crate::BitReader;
#[doc = "Field `VCE` writer - desc VCE"]
pub type VCE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
