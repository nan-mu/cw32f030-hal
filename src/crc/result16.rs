...
pub type R = crate::R<RESULT16_SPEC>;
#[doc = "Field `RESULT16` reader - desc RESULT16"]
pub type RESULT16_R = crate::FieldReader<u16>;
impl R {
...
#[doc = "Result register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`result16::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
