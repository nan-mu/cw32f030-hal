...
pub type CRF_R = crate::svd::BitReader;
#[doc = "Field `ARRF` reader - desc ARRF"]
pub type ARRF_R = crate::svd::BitReader;
#[doc = "Field `WINRF` reader - desc WINRF"]
pub type WINRF_R = crate::svd::BitReader;
...
pub type RUN_R = crate::svd::BitReader;
#[doc = "Field `RELOAD` reader - desc RELOAD"]
pub type RELOAD_R = crate::svd::BitReader;
impl R {
    #[doc = "Bit 0 - desc CRF"]
    #[inline(always)]
