...
pub type R = crate::svd::R<ALARMA_SPEC>;
#[doc = "Register `ALARMA` writer"]
pub type W = crate::svd::W<ALARMA_SPEC>;
...
#[doc = "Alarm - A\n\nYou can [`read`](crate::svd::generic::Reg::read) this register and get [`alarma::R`](R).  You can [`reset`](crate::svd::generic::Reg::reset), [`write`](crate::svd::generic::Reg::write), [`write_with_zero`](crate::svd::generic::Reg::write_with_zero) this register using [`alarma::W`](W). You can also [`modify`](crate::svd::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ALARMA_SPEC;
impl crate::svd::RegisterSpec for ALARMA_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`alarma::R`](R) reader structure"]
impl crate::svd::Readable for ALARMA_SPEC {}
#[doc = "`write(|w| ..)` method takes [`alarma::W`](W) writer structure"]
impl crate::svd::Writable for ALARMA_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ALARMA to value 0"]
impl crate::svd::Resettable for ALARMA_SPEC {
