...
pub type R = crate::svd::R<LSI_SPEC>;
#[doc = "Register `LSI` writer"]
pub type W = crate::svd::W<LSI_SPEC>;
#[doc = "Field `TRIM` reader - desc TRIM"]
pub type TRIM_R = crate::svd::FieldReader<u16>;
#[doc = "Field `TRIM` writer - desc TRIM"]
pub type TRIM_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 10, O, u16>;
