...
pub type HSIEN_R = crate::svd::BitReader;
#[doc = "Field `HSIEN` writer - desc HSIEN"]
pub type HSIEN_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `HSEEN` reader - desc HSEEN"]
pub type HSEEN_R = crate::svd::BitReader;
#[doc = "Field `HSEEN` writer - desc HSEEN"]
pub type HSEEN_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `PLLEN` reader - desc PLLEN"]
pub type PLLEN_R = crate::svd::BitReader;
#[doc = "Field `PLLEN` writer - desc PLLEN"]
pub type PLLEN_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `LSIEN` reader - desc LSIEN"]
pub type LSIEN_R = crate::svd::BitReader;
#[doc = "Field `LSIEN` writer - desc LSIEN"]
pub type LSIEN_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `LSEEN` reader - desc LSEEN"]
pub type LSEEN_R = crate::svd::BitReader;
#[doc = "Field `LSEEN` writer - desc LSEEN"]
pub type LSEEN_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `LSELOCK` reader - desc LSELOCK"]
pub type LSELOCK_R = crate::svd::BitReader;
#[doc = "Field `LSELOCK` writer - desc LSELOCK"]
pub type LSELOCK_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `LSECCS` reader - desc LSECCS"]
pub type LSECCS_R = crate::svd::BitReader;
#[doc = "Field `LSECCS` writer - desc LSECCS"]
pub type LSECCS_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `HSECCS` reader - desc HSECCS"]
pub type HSECCS_R = crate::svd::BitReader;
#[doc = "Field `HSECCS` writer - desc HSECCS"]
pub type HSECCS_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `CLKCCS` reader - desc CLKCCS"]
pub type CLKCCS_R = crate::svd::BitReader;
#[doc = "Field `CLKCCS` writer - desc CLKCCS"]
pub type CLKCCS_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
