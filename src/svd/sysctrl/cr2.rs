...
pub type SWDIO_R = crate::svd::BitReader;
#[doc = "Field `SWDIO` writer - desc SWDIO"]
pub type SWDIO_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
...
pub type WAKEUPCLK_R = crate::svd::BitReader;
#[doc = "Field `WAKEUPCLK` writer - desc WAKEUPCLK"]
pub type WAKEUPCLK_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
