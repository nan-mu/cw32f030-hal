...
pub type R = crate::svd::R<TIMITR_SPEC>;
#[doc = "Register `TIMITR` writer"]
pub type W = crate::svd::W<TIMITR_SPEC>;
#[doc = "Field `ATIMITR` reader - desc ATIMITR"]
pub type ATIMITR_R = crate::svd::FieldReader;
#[doc = "Field `ATIMITR` writer - desc ATIMITR"]
pub type ATIMITR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `GTIM1ITR` reader - desc GTIM1ITR"]
pub type GTIM1ITR_R = crate::svd::FieldReader;
#[doc = "Field `GTIM1ITR` writer - desc GTIM1ITR"]
pub type GTIM1ITR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `GTIM2ITR` reader - desc GTIM2ITR"]
pub type GTIM2ITR_R = crate::svd::FieldReader;
#[doc = "Field `GTIM2ITR` writer - desc GTIM2ITR"]
pub type GTIM2ITR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `GTIM3ITR` reader - desc GTIM3ITR"]
pub type GTIM3ITR_R = crate::svd::FieldReader;
#[doc = "Field `GTIM3ITR` writer - desc GTIM3ITR"]
pub type GTIM3ITR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `GTIM4ITR` reader - desc GTIM4ITR"]
pub type GTIM4ITR_R = crate::svd::FieldReader;
#[doc = "Field `GTIM4ITR` writer - desc GTIM4ITR"]
pub type GTIM4ITR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `BTIM1ITR` reader - desc BTIM1ITR"]
pub type BTIM1ITR_R = crate::svd::FieldReader;
#[doc = "Field `BTIM1ITR` writer - desc BTIM1ITR"]
pub type BTIM1ITR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `BTIM2ITR` reader - desc BTIM2ITR"]
pub type BTIM2ITR_R = crate::svd::FieldReader;
#[doc = "Field `BTIM2ITR` writer - desc BTIM2ITR"]
pub type BTIM2ITR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `BTIM3ITR` reader - desc BTIM3ITR"]
pub type BTIM3ITR_R = crate::svd::FieldReader;
#[doc = "Field `BTIM3ITR` writer - desc BTIM3ITR"]
pub type BTIM3ITR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
impl R {
