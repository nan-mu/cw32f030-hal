...
pub type R = crate::svd::R<GTIMETR_SPEC>;
#[doc = "Register `GTIMETR` writer"]
pub type W = crate::svd::W<GTIMETR_SPEC>;
#[doc = "Field `GTIM1ETR` reader - desc GTIM1ETR"]
pub type GTIM1ETR_R = crate::svd::FieldReader;
#[doc = "Field `GTIM1ETR` writer - desc GTIM1ETR"]
pub type GTIM1ETR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `GTIM2ETR` reader - desc GTIM2ETR"]
pub type GTIM2ETR_R = crate::svd::FieldReader;
#[doc = "Field `GTIM2ETR` writer - desc GTIM2ETR"]
pub type GTIM2ETR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `GTIM3ETR` reader - desc GTIM3ETR"]
pub type GTIM3ETR_R = crate::svd::FieldReader;
#[doc = "Field `GTIM3ETR` writer - desc GTIM3ETR"]
pub type GTIM3ETR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `GTIM4ETR` reader - desc GTIM4ETR"]
pub type GTIM4ETR_R = crate::svd::FieldReader;
#[doc = "Field `GTIM4ETR` writer - desc GTIM4ETR"]
pub type GTIM4ETR_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
impl R {
...
#[doc = "GTIM1-4 ETR Control Reg\n\nYou can [`read`](crate::svd::generic::Reg::read) this register and get [`gtimetr::R`](R).  You can [`reset`](crate::svd::generic::Reg::reset), [`write`](crate::svd::generic::Reg::write), [`write_with_zero`](crate::svd::generic::Reg::write_with_zero) this register using [`gtimetr::W`](W). You can also [`modify`](crate::svd::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GTIMETR_SPEC;
impl crate::svd::RegisterSpec for GTIMETR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gtimetr::R`](R) reader structure"]
impl crate::svd::Readable for GTIMETR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`gtimetr::W`](W) writer structure"]
impl crate::svd::Writable for GTIMETR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GTIMETR to value 0"]
impl crate::svd::Resettable for GTIMETR_SPEC {
