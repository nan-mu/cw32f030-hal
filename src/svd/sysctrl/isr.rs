...
pub type HSISTABLE_R = crate::svd::BitReader;
#[doc = "Field `HSESTABLE` reader - desc HSESTABLE"]
pub type HSESTABLE_R = crate::svd::BitReader;
#[doc = "Field `PLLSTABLE` reader - desc PLLSTABLE"]
pub type PLLSTABLE_R = crate::svd::BitReader;
#[doc = "Field `LSISTABLE` reader - desc LSISTABLE"]
pub type LSISTABLE_R = crate::svd::BitReader;
#[doc = "Field `LSESTABLE` reader - desc LSESTABLE"]
pub type LSESTABLE_R = crate::svd::BitReader;
impl R {
