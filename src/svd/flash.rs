...
pub mod cr2;
#[doc = "PAGELOCK (rw) register accessor: Page Write Erase Lock\n\nYou can [`read`](crate::svd::generic::Reg::read) this register and get [`pagelock::R`].  You can [`reset`](crate::svd::generic::Reg::reset), [`write`](crate::svd::generic::Reg::write), [`write_with_zero`](crate::svd::generic::Reg::write_with_zero) this register using [`pagelock::W`]. You can also [`modify`](crate::svd::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pagelock`]
module"]
pub type PAGELOCK = crate::svd::Reg<pagelock::PAGELOCK_SPEC>;
