...
pub type R = crate::svd::R<CCR1_SPEC>;
#[doc = "Register `CCR1` writer"]
pub type W = crate::svd::W<CCR1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccr(&mut self) -> CCR_W<CCR1_SPEC, 0> {
        CCR_W::new(self)
    }
...
#[doc = "capture compare register\n\nYou can [`read`](crate::svd::generic::Reg::read) this register and get [`ccr1::R`](R).  You can [`reset`](crate::svd::generic::Reg::reset), [`write`](crate::svd::generic::Reg::write), [`write_with_zero`](crate::svd::generic::Reg::write_with_zero) this register using [`ccr1::W`](W). You can also [`modify`](crate::svd::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CCR1_SPEC;
impl crate::svd::RegisterSpec for CCR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ccr1::R`](R) reader structure"]
impl crate::svd::Readable for CCR1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ccr1::W`](W) writer structure"]
impl crate::svd::Writable for CCR1_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CCR1 to value 0"]
impl crate::svd::Resettable for CCR1_SPEC {
