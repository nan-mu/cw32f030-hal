...
pub type R = crate::svd::R<CCR3_SPEC>;
#[doc = "Register `CCR3` writer"]
pub type W = crate::svd::W<CCR3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccr(&mut self) -> CCR_W<CCR3_SPEC, 0> {
        CCR_W::new(self)
    }
...
#[doc = "capture compare register\n\nYou can [`read`](crate::svd::generic::Reg::read) this register and get [`ccr3::R`](R).  You can [`reset`](crate::svd::generic::Reg::reset), [`write`](crate::svd::generic::Reg::write), [`write_with_zero`](crate::svd::generic::Reg::write_with_zero) this register using [`ccr3::W`](W). You can also [`modify`](crate::svd::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CCR3_SPEC;
impl crate::svd::RegisterSpec for CCR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ccr3::R`](R) reader structure"]
impl crate::svd::Readable for CCR3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ccr3::W`](W) writer structure"]
impl crate::svd::Writable for CCR3_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CCR3 to value 0"]
impl crate::svd::Resettable for CCR3_SPEC {
