...
pub type CHMUX_R = crate::svd::FieldReader;
#[doc = "Field `CHMUX` writer - desc CHMUX"]
pub type CHMUX_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 4, O>;
#[doc = "Field `DISCARD` reader - desc DISCARD"]
pub type DISCARD_R = crate::svd::BitReader;
#[doc = "Field `DISCARD` writer - desc DISCARD"]
pub type DISCARD_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `ALIGN` reader - desc ALIGN"]
pub type ALIGN_R = crate::svd::BitReader;
#[doc = "Field `ALIGN` writer - desc ALIGN"]
pub type ALIGN_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `DMAEN` reader - desc DMAEN"]
pub type DMAEN_R = crate::svd::BitReader;
#[doc = "Field `DMAEN` writer - desc DMAEN"]
pub type DMAEN_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `WDTCH` reader - desc WDTCH"]
pub type WDTCH_R = crate::svd::FieldReader;
#[doc = "Field `WDTCH` writer - desc WDTCH"]
pub type WDTCH_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 4, O>;
#[doc = "Field `WDTALL` reader - desc WDTALL"]
pub type WDTALL_R = crate::svd::BitReader;
#[doc = "Field `WDTALL` writer - desc WDTALL"]
pub type WDTALL_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
impl R {
