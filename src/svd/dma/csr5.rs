...
pub type R = crate::svd::R<CSR5_SPEC>;
#[doc = "Register `CSR5` writer"]
pub type W = crate::svd::W<CSR5_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<CSR5_SPEC, 0> {
        EN_W::new(self)
    }
    #[doc = "Bit 1 - desc TCIE"]
    #[inline(always)]
    #[must_use]
    pub fn tcie(&mut self) -> TCIE_W<CSR5_SPEC, 1> {
        TCIE_W::new(self)
    }
    #[doc = "Bit 2 - desc TEIE"]
    #[inline(always)]
    #[must_use]
    pub fn teie(&mut self) -> TEIE_W<CSR5_SPEC, 2> {
        TEIE_W::new(self)
    }
    #[doc = "Bit 3 - desc TRANS"]
    #[inline(always)]
    #[must_use]
    pub fn trans(&mut self) -> TRANS_W<CSR5_SPEC, 3> {
        TRANS_W::new(self)
    }
    #[doc = "Bit 4 - desc SRCINC"]
    #[inline(always)]
    #[must_use]
    pub fn srcinc(&mut self) -> SRCINC_W<CSR5_SPEC, 4> {
        SRCINC_W::new(self)
    }
    #[doc = "Bit 5 - desc DSTINC"]
    #[inline(always)]
    #[must_use]
    pub fn dstinc(&mut self) -> DSTINC_W<CSR5_SPEC, 5> {
        DSTINC_W::new(self)
    }
    #[doc = "Bits 6:7 - desc SIZE"]
    #[inline(always)]
    #[must_use]
    pub fn size(&mut self) -> SIZE_W<CSR5_SPEC, 6> {
        SIZE_W::new(self)
    }
...
#[doc = "Channel5 control and status register\n\nYou can [`read`](crate::svd::generic::Reg::read) this register and get [`csr5::R`](R).  You can [`reset`](crate::svd::generic::Reg::reset), [`write`](crate::svd::generic::Reg::write), [`write_with_zero`](crate::svd::generic::Reg::write_with_zero) this register using [`csr5::W`](W). You can also [`modify`](crate::svd::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CSR5_SPEC;
impl crate::svd::RegisterSpec for CSR5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`csr5::R`](R) reader structure"]
impl crate::svd::Readable for CSR5_SPEC {}
#[doc = "`write(|w| ..)` method takes [`csr5::W`](W) writer structure"]
impl crate::svd::Writable for CSR5_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CSR5 to value 0"]
impl crate::svd::Resettable for CSR5_SPEC {
