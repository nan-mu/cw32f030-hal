...
pub type ADDREN_R = crate::svd::BitReader;
#[doc = "Field `ADDREN` writer - desc ADDREN"]
pub type ADDREN_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `SIGNAL` reader - desc SIGNAL"]
pub type SIGNAL_R = crate::svd::BitReader;
#[doc = "Field `SIGNAL` writer - desc SIGNAL"]
pub type SIGNAL_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `CTSEN` reader - desc CTSEN"]
pub type CTSEN_R = crate::svd::BitReader;
#[doc = "Field `CTSEN` writer - desc CTSEN"]
pub type CTSEN_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `RTSEN` reader - desc RTSEN"]
pub type RTSEN_R = crate::svd::BitReader;
#[doc = "Field `RTSEN` writer - desc RTSEN"]
pub type RTSEN_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `RXINV` reader - desc RXINV"]
pub type RXINV_R = crate::svd::BitReader;
#[doc = "Field `RXINV` writer - desc RXINV"]
pub type RXINV_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `TXINV` reader - desc TXINV"]
pub type TXINV_R = crate::svd::BitReader;
#[doc = "Field `TXINV` writer - desc TXINV"]
pub type TXINV_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
