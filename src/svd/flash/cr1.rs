...
pub type STANDBY_R = crate::svd::BitReader;
#[doc = "Field `STANDBY` writer - desc STANDBY"]
pub type STANDBY_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `BUSY` reader - desc BUSY"]
pub type BUSY_R = crate::svd::BitReader;
#[doc = "Field `SECURITY` reader - desc SECURITY"]
pub type SECURITY_R = crate::svd::FieldReader;
