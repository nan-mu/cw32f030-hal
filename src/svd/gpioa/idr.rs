...
pub type R = crate::svd::R<IDR_SPEC>;
#[doc = "Register `IDR` writer"]
pub type W = crate::svd::W<IDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pin0(&mut self) -> PIN0_W<IDR_SPEC, 0> {
        PIN0_W::new(self)
    }
    #[doc = "Bit 1 - desc PIN1"]
    #[inline(always)]
    #[must_use]
    pub fn pin1(&mut self) -> PIN1_W<IDR_SPEC, 1> {
        PIN1_W::new(self)
    }
    #[doc = "Bit 2 - desc PIN2"]
    #[inline(always)]
    #[must_use]
    pub fn pin2(&mut self) -> PIN2_W<IDR_SPEC, 2> {
        PIN2_W::new(self)
    }
    #[doc = "Bit 3 - desc PIN3"]
    #[inline(always)]
    #[must_use]
    pub fn pin3(&mut self) -> PIN3_W<IDR_SPEC, 3> {
        PIN3_W::new(self)
    }
    #[doc = "Bit 4 - desc PIN4"]
    #[inline(always)]
    #[must_use]
    pub fn pin4(&mut self) -> PIN4_W<IDR_SPEC, 4> {
        PIN4_W::new(self)
    }
    #[doc = "Bit 5 - desc PIN5"]
    #[inline(always)]
    #[must_use]
    pub fn pin5(&mut self) -> PIN5_W<IDR_SPEC, 5> {
        PIN5_W::new(self)
    }
    #[doc = "Bit 6 - desc PIN6"]
    #[inline(always)]
    #[must_use]
    pub fn pin6(&mut self) -> PIN6_W<IDR_SPEC, 6> {
        PIN6_W::new(self)
    }
    #[doc = "Bit 7 - desc PIN7"]
    #[inline(always)]
    #[must_use]
    pub fn pin7(&mut self) -> PIN7_W<IDR_SPEC, 7> {
        PIN7_W::new(self)
    }
    #[doc = "Bit 8 - desc PIN8"]
    #[inline(always)]
    #[must_use]
    pub fn pin8(&mut self) -> PIN8_W<IDR_SPEC, 8> {
        PIN8_W::new(self)
    }
    #[doc = "Bit 9 - desc PIN9"]
    #[inline(always)]
    #[must_use]
    pub fn pin9(&mut self) -> PIN9_W<IDR_SPEC, 9> {
        PIN9_W::new(self)
    }
    #[doc = "Bit 10 - desc PIN10"]
    #[inline(always)]
    #[must_use]
    pub fn pin10(&mut self) -> PIN10_W<IDR_SPEC, 10> {
        PIN10_W::new(self)
    }
    #[doc = "Bit 11 - desc PIN11"]
    #[inline(always)]
    #[must_use]
    pub fn pin11(&mut self) -> PIN11_W<IDR_SPEC, 11> {
        PIN11_W::new(self)
    }
    #[doc = "Bit 12 - desc PIN12"]
    #[inline(always)]
    #[must_use]
    pub fn pin12(&mut self) -> PIN12_W<IDR_SPEC, 12> {
        PIN12_W::new(self)
    }
    #[doc = "Bit 13 - desc PIN13"]
    #[inline(always)]
    #[must_use]
    pub fn pin13(&mut self) -> PIN13_W<IDR_SPEC, 13> {
        PIN13_W::new(self)
    }
    #[doc = "Bit 14 - desc PIN14"]
    #[inline(always)]
    #[must_use]
    pub fn pin14(&mut self) -> PIN14_W<IDR_SPEC, 14> {
        PIN14_W::new(self)
    }
    #[doc = "Bit 15 - desc PIN15"]
    #[inline(always)]
    #[must_use]
    pub fn pin15(&mut self) -> PIN15_W<IDR_SPEC, 15> {
        PIN15_W::new(self)
    }
...
#[doc = "desc IDR\n\nYou can [`read`](crate::svd::generic::Reg::read) this register and get [`idr::R`](R).  You can [`reset`](crate::svd::generic::Reg::reset), [`write`](crate::svd::generic::Reg::write), [`write_with_zero`](crate::svd::generic::Reg::write_with_zero) this register using [`idr::W`](W). You can also [`modify`](crate::svd::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IDR_SPEC;
impl crate::svd::RegisterSpec for IDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`idr::R`](R) reader structure"]
impl crate::svd::Readable for IDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`idr::W`](W) writer structure"]
impl crate::svd::Writable for IDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IDR to value 0"]
impl crate::svd::Resettable for IDR_SPEC {
