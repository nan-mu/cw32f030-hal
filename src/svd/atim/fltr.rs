...
pub type R = crate::svd::R<FLTR_SPEC>;
#[doc = "Register `FLTR` writer"]
pub type W = crate::svd::W<FLTR_SPEC>;
#[doc = "Field `OCM1AFLT1A` reader - desc OCM1AFLT1A"]
pub type OCM1AFLT1A_R = crate::svd::FieldReader;
#[doc = "Field `OCM1AFLT1A` writer - desc OCM1AFLT1A"]
pub type OCM1AFLT1A_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `CCP1A` reader - desc CCP1A"]
pub type CCP1A_R = crate::svd::BitReader;
#[doc = "Field `CCP1A` writer - desc CCP1A"]
pub type CCP1A_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `OCM1BFLT1B` reader - desc OCM1BFLT1B"]
pub type OCM1BFLT1B_R = crate::svd::FieldReader;
#[doc = "Field `OCM1BFLT1B` writer - desc OCM1BFLT1B"]
pub type OCM1BFLT1B_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `CCP1B` reader - desc CCP1B"]
pub type CCP1B_R = crate::svd::BitReader;
#[doc = "Field `CCP1B` writer - desc CCP1B"]
pub type CCP1B_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `OCM2AFLT2A` reader - desc OCM2AFLT2A"]
pub type OCM2AFLT2A_R = crate::svd::FieldReader;
#[doc = "Field `OCM2AFLT2A` writer - desc OCM2AFLT2A"]
pub type OCM2AFLT2A_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `CCP2A` reader - desc CCP2A"]
pub type CCP2A_R = crate::svd::BitReader;
#[doc = "Field `CCP2A` writer - desc CCP2A"]
pub type CCP2A_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `OCM2BFLT2B` reader - desc OCM2BFLT2B"]
pub type OCM2BFLT2B_R = crate::svd::FieldReader;
#[doc = "Field `OCM2BFLT2B` writer - desc OCM2BFLT2B"]
pub type OCM2BFLT2B_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `CCP2B` reader - desc CCP2B"]
pub type CCP2B_R = crate::svd::BitReader;
#[doc = "Field `CCP2B` writer - desc CCP2B"]
pub type CCP2B_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `OCM3AFLT3A` reader - desc OCM3AFLT3A"]
pub type OCM3AFLT3A_R = crate::svd::FieldReader;
#[doc = "Field `OCM3AFLT3A` writer - desc OCM3AFLT3A"]
pub type OCM3AFLT3A_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `CCP3A` reader - desc CCP3A"]
pub type CCP3A_R = crate::svd::BitReader;
#[doc = "Field `CCP3A` writer - desc CCP3A"]
pub type CCP3A_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `OCM3BFLT3B` reader - desc OCM3BFLT3B"]
pub type OCM3BFLT3B_R = crate::svd::FieldReader;
#[doc = "Field `OCM3BFLT3B` writer - desc OCM3BFLT3B"]
pub type OCM3BFLT3B_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `CCP3B` reader - desc CCP3B"]
pub type CCP3B_R = crate::svd::BitReader;
#[doc = "Field `CCP3B` writer - desc CCP3B"]
pub type CCP3B_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `FLTBK` reader - desc FLTBK"]
pub type FLTBK_R = crate::svd::FieldReader;
#[doc = "Field `FLTBK` writer - desc FLTBK"]
pub type FLTBK_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `BKP` reader - desc BKP"]
pub type BKP_R = crate::svd::BitReader;
#[doc = "Field `BKP` writer - desc BKP"]
pub type BKP_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `FLTET` reader - desc FLTET"]
pub type FLTET_R = crate::svd::FieldReader;
#[doc = "Field `FLTET` writer - desc FLTET"]
pub type FLTET_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 3, O>;
#[doc = "Field `ETP` reader - desc ETP"]
pub type ETP_R = crate::svd::BitReader;
#[doc = "Field `ETP` writer - desc ETP"]
pub type ETP_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
impl R {
...
#[doc = "desc FLTR\n\nYou can [`read`](crate::svd::generic::Reg::read) this register and get [`fltr::R`](R).  You can [`reset`](crate::svd::generic::Reg::reset), [`write`](crate::svd::generic::Reg::write), [`write_with_zero`](crate::svd::generic::Reg::write_with_zero) this register using [`fltr::W`](W). You can also [`modify`](crate::svd::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FLTR_SPEC;
impl crate::svd::RegisterSpec for FLTR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fltr::R`](R) reader structure"]
impl crate::svd::Readable for FLTR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`fltr::W`](W) writer structure"]
impl crate::svd::Writable for FLTR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets FLTR to value 0"]
impl crate::svd::Resettable for FLTR_SPEC {
