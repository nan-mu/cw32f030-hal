...
pub type RESP_R = crate::svd::FieldReader;
#[doc = "Field `RESP` writer - desc RESP"]
pub type RESP_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 2, O>;
#[doc = "Field `HYS` reader - desc HYS"]
pub type HYS_R = crate::svd::FieldReader;
#[doc = "Field `HYS` writer - desc HYS"]
pub type HYS_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 2, O>;
...
pub type WINDOW_W<'a, REG, const O: u8> = crate::svd::BitWriter<'a, REG, O>;
#[doc = "Field `INP` reader - desc INP"]
pub type INP_R = crate::svd::FieldReader;
#[doc = "Field `INP` writer - desc INP"]
pub type INP_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 4, O>;
#[doc = "Field `INN` reader - desc INN"]
pub type INN_R = crate::svd::FieldReader;
#[doc = "Field `INN` writer - desc INN"]
pub type INN_W<'a, REG, const O: u8> = crate::svd::FieldWriter<'a, REG, 4, O>;
impl R {
    #[doc = "Bit 0 - desc EN"]
    #[inline(always)]
    pub fn en(&self) -> EN_R {
