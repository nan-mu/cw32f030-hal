...
pub mod cr2;
#[doc = "PAGELOCK (rw) register accessor: Page Write Erase Lock\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pagelock::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pagelock::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pagelock`]
module"]
pub type PAGELOCK = crate::Reg<pagelock::PAGELOCK_SPEC>;
