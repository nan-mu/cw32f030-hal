...
pub type BGREN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type REF_R = crate::FieldReader;
#[doc = "Field `REF` writer - desc REF"]
pub type REF_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type SAM_R = crate::FieldReader;
#[doc = "Field `SAM` writer - desc SAM"]
pub type SAM_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
#[doc = "Field `BUF` reader - desc BUF"]
pub type BUF_R = crate::BitReader;
#[doc = "Field `BUF` writer - desc BUF"]
pub type BUF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
